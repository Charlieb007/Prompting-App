...
// Pure presentational components — no state, no props beyond what individual
// icons need (StarIcon takes `filled`). Stroke and fill use currentColor so
// each icon adopts the color of its parent.
...
export function PinIcon({ filled = false }) {
  return (
    <svg viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2a4 4 0 0 1 4 4c0 1.5-.5 2.8-1.4 3.8L16 17H8l1.4-7.2A5.97 5.97 0 0 1 8 6a4 4 0 0 1 4-4z" />
